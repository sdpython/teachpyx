...
def deux_recherches(element, liste1, liste2):
    return recherche_dichotomique(element, liste1), recherche_dichotomique(
        element, liste2
    )
...
Conclusion : pour n petit, le cas C1 est pr�f�rable, pour les n grands, c'est le cas 2.
"""
