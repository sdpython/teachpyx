...
# question 3
pos = ec.index(max(ec))
print("position de l'�cart le plus grand ", pos)
...
et 2 fois pour les autres en effet, la m�thode difference effectue
la conversion en num�ros des dates self et autre
...
# question 9
"""
On peut par exemple stocker la conversion en num�ro
