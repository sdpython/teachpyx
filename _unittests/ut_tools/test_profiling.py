...
from teachpyx import __file__ as rootfile
from teachpyx.ext_test_case import ExtTestCase, ignore_warnings
from teachpyx.tools.profiling import ProfileNode, profile, profile2df, profile2graph
...
class TestProfiling(ExtTestCase):
    ...
    def test_profile_df_verbose(self):
        ...
        ps = profile(f4)[0]
        df = self.capture(lambda: profile2df(ps, verbose=True, logf=print))[0]
